...
- These are the minimum required vars need to setup to make MyMusicBot Music Bot functional.
...
8. `STRING_SESSION` : Pyrogram Session Needed, Generate string from [@MyMusicBotStringBot](http://t.me/MyMusicBotStringBot) in Telegram.
...
- You can play tracks or playlists from spotify from MyMusicBot Music bot
...
- If you plan to use MyMusicBot Music Bot with your own customized or modified code.
...
- You can change images which are used in MyMusicBot Music Bot.
- You can generate telegaph links from [@MyMusicBotTelegraphBot](http://t.me/MyMusicBotTelegraphBot) and use it here.
...
1. `STRING_SESSION2` : Pyrogram Session Needed, Generate string from [@MyMusicBotStringBot](http://t.me/MyMusicBotStringBot) in Telegram.
2. `STRING_SESSION3` : Pyrogram Session Needed, Generate string from [@MyMusicBotStringBot](http://t.me/MyMusicBotStringBot) in Telegram.
3. `STRING_SESSION4` : Pyrogram Session Needed, Generate string from [@MyMusicBotStringBot](http://t.me/MyMusicBotStringBot) in Telegram.
4. `STRING_SESSION5` : Pyrogram Session Needed, Generate string from [@MyMusicBotStringBot](http://t.me/MyMusicBotStringBot) in Telegram.
