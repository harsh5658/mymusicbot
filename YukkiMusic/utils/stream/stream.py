...
import config
from MyMusicBotMusic import Carbon, YouTube, app
from MyMusicBotMusic.core.call import MyMusicBot
from MyMusicBotMusic.misc import db
from MyMusicBotMusic.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from MyMusicBotMusic.utils.exceptions import AssistantErr
from MyMusicBotMusic.utils.inline.play import (stream_markup,
                                          telegram_markup)
from MyMusicBotMusic.utils.inline.playlist import close_markup
from MyMusicBotMusic.utils.pastebin import MyMusicBotbin
from MyMusicBotMusic.utils.stream.queue import put_queue, put_queue_index
...
async def stream(
    ...
    if forceplay:
        await MyMusicBot.force_stop_stream(chat_id)
