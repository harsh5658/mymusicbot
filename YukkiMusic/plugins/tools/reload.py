...
from MyMusicBotMusic import app
from MyMusicBotMusic.core.call import MyMusicBot
from MyMusicBotMusic.misc import db
from MyMusicBotMusic.utils.database import get_authuser_names, get_cmode
from MyMusicBotMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from MyMusicBotMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await MyMusicBot.stop_stream(message.chat.id)
    except:
        pass
