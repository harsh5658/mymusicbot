...
from MyMusicBotMusic import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, app)
from MyMusicBotMusic.core.call import MyMusicBot
from MyMusicBotMusic.utils import seconds_to_min, time_to_seconds
from MyMusicBotMusic.utils.channelplay import get_channeplayCB
from MyMusicBotMusic.utils.database import is_video_allowed
from MyMusicBotMusic.utils.decorators.language import languageCB
from MyMusicBotMusic.utils.decorators.play import PlayWrapper
from MyMusicBotMusic.utils.formatters import formats
from MyMusicBotMusic.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from MyMusicBotMusic.utils.inline.playlist import botplaylist_markup
from MyMusicBotMusic.utils.logger import play_logs
from MyMusicBotMusic.utils.stream.stream import stream
...
async def play_commnd(
    ...
    if audio_telegram:
        ...
        if await YouTube.exists(url):
            ...
            try:
                await MyMusicBot.stream_call(url)
...
@app.on_callback_query(
    filters.regex("MyMusicBotPlaylists") & ~BANNED_USERS
)
@languageCB
